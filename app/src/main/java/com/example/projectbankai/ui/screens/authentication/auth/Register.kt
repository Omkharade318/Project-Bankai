        ...
        LazyColumn {
            item{
                Column(
                    ...
                    Image(
                        painter = painterResource(id = R.drawable.laptop_lady),
                    ...
                    OutlinedTextField(
                        ...
                        placeholder = { Text(text = "Enter a User Name", color = LightPurple) },
                        label = { Text(text = "User Name", color = LightPurple) },
                        singleLine = true,
                    ...
                    OutlinedTextField(
                        ...
                        placeholder = { Text(text = "Enter a Password", color = LightPurple) },
                    ...
                    Button(
                        onClick = {
                            ...
                            if(userEmail.isNotEmpty() && password.isNotEmpty()){
                                ...
                                Toast.makeText(context, "You can't keep User Name, email and password Empty", Toast.LENGTH_SHORT).show()
                            }
